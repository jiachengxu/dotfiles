# Generated by Powerlevel10k configuration wizard on 2020-11-21 at 15:22 CST.
...
#    proxy                 # system-wide http/https/ftp proxy
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_CLASSES=(
      '*gke*'  GKE    # to match your needs. Customize them as needed.
      '*'       DEFAULT)
  typeset -g POWERLEVEL9K_KUBECONTEXT_GKE_FOREGROUND=0
  typeset -g POWERLEVEL9K_KUBECONTEXT_GKE_BACKGROUND=6
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_GKE_CONTENT_EXPANSION=
  # Show P9K_KUBECONTEXT_CLOUD_CLUSTER if it's not empty and fall back to P9K_KUBECONTEXT_NAME.
  POWERLEVEL9K_KUBECONTEXT_GKE_CONTENT_EXPANSION+='${P9K_KUBECONTEXT_CLOUD_NAME}-${P9K_KUBECONTEXT_CLOUD_CLUSTER}'
  # Append the current context's namespace if it's not "default".
  POWERLEVEL9K_KUBECONTEXT_GKE_CONTENT_EXPANSION+='${${:-/$P9K_KUBECONTEXT_NAMESPACE}:#/default}'
